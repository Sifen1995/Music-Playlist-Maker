...
export default function CreatePlaylist({ onSave, closeModal }: { onSave: (name: string, description: string) => void, closeModal: () => void }) {
  const [name, setName] = useState<string>('');
  const [description, setDescription] = useState<string>('');
  ...
  return (
    <div className='fixed inset-0 flex items-center justify-center bg-black bg-opacity-50'>
      <div className='max-w-[700px] max-h-[300px] bg-amber-100 rounded-[15px] p-3 flex flex-col gap-4'>
